...
output_pointcloud_filename = 'recon/pointcloud.txt'
imgs_height_cm = 6.0
...
def process_image(image_file, pose_line, sensor_to_image_transf):
...
for image_file, pose_line in zip(sorted_image_files, pose_lines):
    ...
    process_image(full_image_path, pose_line, sensor_to_image_transf)
